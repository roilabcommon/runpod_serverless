...
class VibeVoiceConfig(PretrainedConfig):
    ...
    def num_hidden_layers(self):
        """Expose num_hidden_layers from decoder_config for compatibility with GenerationMixin."""
        return self.decoder_config.num_hidden_layers

    @property
    def num_attention_heads(self):
        """Expose num_attention_heads from decoder_config for compatibility with GenerationMixin."""
        return self.decoder_config.num_attention_heads

    @property
    def num_key_value_heads(self):
        """Expose num_key_value_heads from decoder_config for compatibility with GenerationMixin."""
        return getattr(self.decoder_config, 'num_key_value_heads', self.decoder_config.num_attention_heads)

    @property
    def hidden_size(self):
        """Expose hidden_size from decoder_config for compatibility with GenerationMixin."""
        return self.decoder_config.hidden_size

    @property
    def head_dim(self):
        """Expose head_dim from decoder_config for compatibility with GenerationMixin."""
        return getattr(self.decoder_config, 'head_dim', self.decoder_config.hidden_size // self.decoder_config.num_attention_heads)
